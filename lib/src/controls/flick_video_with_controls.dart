...
class _FlickVideoWithControlsState extends State<FlickVideoWithControls> {
  ...
  Widget build(BuildContext context) {
    ...
    bool showVideoCaption = controlManager.isSub;
    return IconTheme(
      ...
      child: LayoutBuilder(builder: (context, size) {
        return Container(
          ...
          child: DefaultTextStyle(
            ...
            child: Stack(
              children: <Widget>[
                if (widget.bgWidget != null) ...[widget.bgWidget!],
                if (widget.imageActiveBg == null) ...[
                  Center(
                  ...
                  Image.network(widget.imageActiveBg!,
                      fit: widget.videoFit,
                      width: widget.imageWidth,
                      height: widget.imageHeight),
                ],
